...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "Our pricing is simple and transparent. We charge by the kilogram, starting from 22 SAR/kg. Special garments like thobes and abayas have per-piece pricing.",
  },
  {
