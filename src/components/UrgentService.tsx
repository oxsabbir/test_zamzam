    ...
    >
      <div className="container mx-auto px-3 sm:px-4">
        <header className="text-center mb-8 sm:mb-12">
          ...
          >
            In a Hurry? We Offer the Quickest Turnaround
          </h2>
          <p className="text-base sm:text-lg text-slate-700 max-w-3xl mx-auto">
            Experience lightning-fast cleaning and same-day delivery. Our
            express services are designed to keep you fresh without disrupting
            your schedule.
          </p>
        </header>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto">
          ...
          <div className="rounded-lg text-card-foreground shadow-sm p-6 text-center hover:shadow-xl transition-all hover:-translate-y-1 border bg-primary/10  dark:bg-green-900/10 hover:opacity-90">
            ...
            <p className="text-sm text-slate-700 mb-4">Reliable & convenient</p>
            <button
              id="generate_lead"
