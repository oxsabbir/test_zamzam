...
import heroImage from "@/assets/hero-nasir.webp";
...
const HeroNew = () => {
  ...
  return (
    <section
      id="hero"
      className="relative overflow-hidden bg-gradient-to-r from-black via-primary-900 to-black min-h-screen flex items-center pt-16"
    >
      <FloatingCTA />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-black/30 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-6 mb-4 sm:mb-8">
            <div className="flex items-center justify-center mb-2 sm:mb-3">
              ...
              <span className="text-primary-foreground ml-2 font-bold text-sm sm:text-base">
                Rated 4.9 by 5,000+ Customers
              </span>
            </div>
            <p className="text-sm sm:text-xl text-primary-foreground/95 font-medium mb-3 sm:mb-4 px-2">
              "They picked up my laundry in under 15 minutes and delivered it
              fresh the same day.
              <span className="text-primary-300 font-bold">
                {" "}
                Zamzam Laundry Nasir
              </span>{" "}
              made my Umrah trip so much easier!"
            </p>
          ...
          <div className="space-y-3 sm:space-y-4 px-2">
            ...
            <div className="text-primary-foreground/90 flex flex-wrap pt-4 items-center justify-center gap-4 text-xs sm:text-base">
              ...
              <span>|</span>
              <span className="flex items-center gap-2">
                <Quote size={18} /> No Hidden Charges
              </span>
              <span>|</span>
              <span className="flex items-center gap-2">
